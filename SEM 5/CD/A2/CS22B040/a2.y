...
condition_statement:
    IF '(' condition_list ')' {{cout<<if_label<<":"<<endl;}}  body {exit_label=generate("L",ifs_num);cout<<"goto "<<exit_label<<endl;} ELSE {{cout<<else_label<<" :"<<endl;}} body {{cout<<exit_label<<" :"<<endl;}}
...
condition_list:
    ...
    | expression {{string label = generate("L",ifs_num); cout << "if " << "(" <<$1 <<")"<< " goto " << label << endl;if(else_label=="")else_label=generate("L",ifs_num);cout << "goto " << else_label << endl; }} AND condition_list 
